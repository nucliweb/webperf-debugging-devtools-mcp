...
Ahora vamos a usar el **Chrome DevTools MCP** para que Gemini analice la demo, pero simularemos un entorno de producción donde el código está minificado.
...
### El Problema
Gemini te dirá algo como: "La función `a()` en `script.min.js` ha tardado 2000ms".
